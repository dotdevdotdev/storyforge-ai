...
// Centralized design tokens and styles
...
export const components = {
  ...
  input: {
    base: 'block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors',
    sizes: {
      sm: 'px-3 py-1.5 text-sm',
  ...
  card: {
    ...
    hover: 'hover:shadow-lg hover:border-gray-300 hover:-translate-y-0.5 transition-all duration-300 ease-out',
  },
  
  nav: {
    base: 'text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md transition-colors',
