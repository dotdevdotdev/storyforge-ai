...
class StoryService {
  ...
  async updateStory(storyId, updates) {
    try {
      ...
      const story = await this.stories.findOne({ _id: new ObjectId(storyId) });
  ...
  async getStory(storyId) {
    try {
      ...
      return await this.stories.findOne({ _id: new ObjectId(storyId) });
    } catch (error) {
  ...
  async getDraft(draftId) {
    try {
      ...
      return await this.drafts.findOne({ _id: new ObjectId(draftId) });
    } catch (error) {
